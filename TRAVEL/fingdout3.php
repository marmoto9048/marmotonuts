...
color:#454545;">请输入要检索的title信息(根据id排序)： </h3>
...
$q="SELECT count(*) FROM apply where title like  '%".$keyword."%'  order by id desc";
//$q="SELECT count(*) FROM apply where title like  '%".$keyword."%'  order by people desc";
echo 'q: '.$q.'<br>';
$k="SELECT * FROM apply where title like '%".$keyword."%' order by id desc";//对表apply进行选择  
echo $k;
